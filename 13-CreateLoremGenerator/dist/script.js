...
function loremIpsum(size) {
    ...
    // showing / hiding the text container/wrapper
    if (result) {
        document.querySelector('.text-wrapper').classList.add('flex')
        document.querySelector('.text-wrapper').classList.remove('hidden')
    } else {
        document.querySelector('.text-wrapper').classList.remove('flex')
        document.querySelector('.text-wrapper').classList.add('hidden')
    }
    return result;
}
